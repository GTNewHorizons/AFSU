...
public class ConfigHandler {
    ...
    public static void init(File file) {
        ...
        config.load();
        {
            afsutexture = config.getString(
                    "AFSU Texture",
                    "Textures",
                    "default",
                    "Changes the texture of the AFSU. Possible values: default, blue, yellow, black, old, chloe1, chloe2, chloe3, freezy",
                    usableValuesAFSU);
            afbtexture = config.getString(
                    "AFB Texture",
                    "Textures",
                    "default",
                    "Changes the texture of the AFB. Possible values: default",
                    usableValuesAFB);
            ...
            AFSUGuiButtonxpart = config
                    .getInt("GuiButtonXPart", "GUI", 10, Integer.MIN_VALUE, Integer.MAX_VALUE, WARNING);
            AFSUGuiButtonypart = config
                    .getInt("GuiButtonYPart", "GUI", 7, Integer.MIN_VALUE, Integer.MAX_VALUE, WARNING);
            ...
            AFSUArmxDispPosition = config
                    .getInt("ArmXDispPosition", "ContainerGUI", 152, 0, Integer.MAX_VALUE, WARNING);
